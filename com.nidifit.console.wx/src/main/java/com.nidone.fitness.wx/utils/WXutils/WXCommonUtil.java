package com.nidone.fitness.wx.utils.WXutils;
...
//        String appsecret="4091cc46ec01ac8122bcd2f5364bfad2";
        String appid="wx672373b33d5a1143";
        String appsecret="ca4cb2b898677a618a5455243248cb68";
    ...
    public static JSONObject CreateMenu(String access_token){
        ...
        String data="{\n" +
                ...
                "            \"type\": \"view\",\n" +
                "            \"name\": \"我的主页\",\n" +
                "            \"url\": \"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx672373b33d5a1143&redirect_uri=http://6246f23f.ngrok.io/v1/homepage&response_type=code&scope=snsapi_base&state=123#wechat_redirect\"\n" +
                "        },\n" +
                "        {\n" +
                "            \"type\": \"view\",\n" +
                "            \"name\": \"课程训练\",\n" +
        ...
        JSONObject jo= HttpRequestUtil.httpsRequest(url,"POST",data);
         return jo;
    }
}
